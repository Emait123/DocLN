...
sealed class Routes(val name: String, val icon: ImageVector, val route: String) {
    ...
    object ChangePassword : Routes(name = "Đổi mật khẩu", icon = Icons.Filled.AccountCircle, route = "changePassword")
    object sensor : Routes(name = "sensor", icon = Icons.Filled.AccountCircle, route = "sensor")
